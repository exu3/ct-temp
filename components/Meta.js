...
export default function Meta({ title }) {
  const description =
    "Command Tech is a fiscally sponsored nonprofit utilising the power of technology to inspire female and nonbinary students.";
  const keywords = "STEM, female, girls, nonbinary, coding, computer science";
  const author = "Ella";
  const twitter = "@ella";
  const image =
